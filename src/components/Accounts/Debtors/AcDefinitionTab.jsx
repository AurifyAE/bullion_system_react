      ...
      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <SelectField
            ...
            onChange={(e) => {
              const selectedCurrency = currencyOptions.find(c => c.no === parseInt(e.target.value));
          ...
          <InputField
            ...
            type="number"
            step="0.01"
            value={acDefinitionData.currency.salRate}
            readOnly
          />
          <InputField
            label="Purchase Rate"
            type="number"
            step="0.01"
            value={acDefinitionData.currency.purRate}
            readOnly
          />
