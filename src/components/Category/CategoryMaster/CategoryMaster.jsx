...
// Dummy data for CategoryMaster
const initialCategories = [
  { id: 1, code: 'CAT001', description: 'Gold Bullion' },
  { id: 2, code: 'CAT002', description: 'Silver Bullion' },
  { id: 3, code: 'CAT003', description: 'Platinum Bullion' },
];
...
const CategoryMaster = () => {
  ...
  const handleEdit = (category) => {
    ...
    setFormData({ code: category.code, description: category.description });
    setIsModalOpen(true);
  };
